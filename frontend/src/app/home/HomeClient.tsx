...
export default function Home() {
    ...
    return (
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 min-h-[85vh] flex items-center">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 w-full items-center">
                {/* LEFT: Welcome Content (7 columns) */}
                <div className="lg:col-span-7 flex flex-col items-start text-left">
                    <div className="inline-flex items-center gap-2 bg-cusblue/5 px-4 py-2 rounded-full mb-6 sm:mb-8 animate-fade-in">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-cusblue tracking-tighter mb-6 leading-[1.1]">
                        Welcome to your <br />
                    ...
                    <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 w-full sm:w-auto">
                        <Button
                            ...
                            className="group flex items-center justify-center gap-3 bg-cusblue text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-bold text-base sm:text-lg shadow-[0_10px_30px_rgba(var(--cusblue-rgb),0.3)] hover:opacity-90 transition-all active:scale-95 w-full sm:w-auto">
                            Go to My Events
